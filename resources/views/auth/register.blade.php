                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <p>
                                    <input id='sex1' type='radio' name='sex' value='man'>男性
                                    <input id='sex2' type='radio' name='sex' value='woman'>女性                                    
                                    <input id='sex3' type='radio' name='sex' value='others'>その他
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="date" name="age" max='9999-12-20' required>
                            </div>
                        </div>
